...
export default async function(sch, {variant}) {
	...
	*/
	...
	screw2.pin(3).connect(esp32.gpio0); // io1
	screw2.pin(4).connect(esp32.gpio1); // io2

	screw3.pin(1).connect("GND");
	screw3.pin(2).connect("3V3");
	screw3.pin(3).connect(esp32.gpio3); // io3
	screw3.pin(4).connect(esp32.gpio6); // io4

	screw4.pin(1).connect(esp32.gpio7); // io5
